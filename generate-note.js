// This runs ONLY on the server (Vercel serverless function).
// The API key never reaches the browser — this is the whole point of Phase 0.
...
export default async function handler(req, res) {
  ...
  // Two outputs from one visit: a clinical record (English, structured)
  // and a patient-facing summary (in the requested language, plain terms).
